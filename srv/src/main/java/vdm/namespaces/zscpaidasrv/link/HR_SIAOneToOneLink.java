...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.zscpaidasrv.HR_SIA HR_SIA} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.zscpaidasrv.link.HR_SIALink HR_SIALink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class HR_SIAOneToOneLink<ObjectT extends VdmObject<?> >
    extends HR_SIALink<ObjectT>
    implements OneToOneLink<HR_SIA, ObjectT>
{
     ...
     */
    public HR_SIAOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<HR_SIA> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<HR_SIA>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
