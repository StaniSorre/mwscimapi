...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.zscpaidasrv.Fornitore Fornitore} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.zscpaidasrv.link.FornitoreLink FornitoreLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class FornitoreOneToOneLink<ObjectT extends VdmObject<?> >
    extends FornitoreLink<ObjectT>
    implements OneToOneLink<Fornitore, ObjectT>
{
     ...
     */
    public FornitoreOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Fornitore> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<Fornitore>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
