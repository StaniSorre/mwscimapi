...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.zscpaidasrv.Hrorg Hrorg} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.zscpaidasrv.link.HrorgLink HrorgLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class HrorgOneToOneLink<ObjectT extends VdmObject<?> >
    extends HrorgLink<ObjectT>
    implements OneToOneLink<Hrorg, ObjectT>
{
     ...
     */
    public HrorgOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Hrorg> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<Hrorg>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
