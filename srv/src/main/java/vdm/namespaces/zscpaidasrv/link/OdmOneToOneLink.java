...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.zscpaidasrv.Odm Odm} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.zscpaidasrv.link.OdmLink OdmLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class OdmOneToOneLink<ObjectT extends VdmObject<?> >
    extends OdmLink<ObjectT>
    implements OneToOneLink<Odm, ObjectT>
{
     ...
     */
    public OdmOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Odm> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<Odm>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
