...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.zscpaidasrv.HR_MNG HR_MNG} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.zscpaidasrv.link.HR_MNGLink HR_MNGLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class HR_MNGOneToOneLink<ObjectT extends VdmObject<?> >
    extends HR_MNGLink<ObjectT>
    implements OneToOneLink<HR_MNG, ObjectT>
{
     ...
     */
    public HR_MNGOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<HR_MNG> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<HR_MNG>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
