...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.zscpaidasrv.HR_SIA HR_SIA}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class HR_SIAField<FieldT >
    extends EntityField<HR_SIA, FieldT>
    implements HR_SIASelectable
{
     ...
     */
    public HR_SIAField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public HR_SIAField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
