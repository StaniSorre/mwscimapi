...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.zscpaidasrv.Fornitore Fornitore}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class FornitoreField<FieldT >
    extends EntityField<Fornitore, FieldT>
    implements FornitoreSelectable
{
     ...
     */
    public FornitoreField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public FornitoreField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
