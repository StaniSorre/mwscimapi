...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.zscpaidasrv.HR_MNG HR_MNG}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class HR_MNGField<FieldT >
    extends EntityField<HR_MNG, FieldT>
    implements HR_MNGSelectable
{
     ...
     */
    public HR_MNGField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public HR_MNGField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
