...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.zscpaidasrv.ZAIDA_HR_PERS ZAIDA_HR_PERS}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ZAIDA_HR_PERSField<FieldT >
    extends EntityField<ZAIDA_HR_PERS, FieldT>
    implements ZAIDA_HR_PERSSelectable
{
     ...
     */
    public ZAIDA_HR_PERSField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public ZAIDA_HR_PERSField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
