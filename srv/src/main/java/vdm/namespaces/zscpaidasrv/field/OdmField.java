...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.zscpaidasrv.Odm Odm}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class OdmField<FieldT >
    extends EntityField<Odm, FieldT>
    implements OdmSelectable
{
     ...
     */
    public OdmField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public OdmField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
