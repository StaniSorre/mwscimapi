...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.zscpaidasrv.HR_PERS HR_PERS}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class HR_PERSField<FieldT >
    extends EntityField<HR_PERS, FieldT>
    implements HR_PERSSelectable
{
     ...
     */
    public HR_PERSField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public HR_PERSField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
